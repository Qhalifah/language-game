...
//    flexstring input;
//    fin >> input;
//	string s((const char*)&input[0], sizeof(wchar_t) / sizeof(char)*input.size());
//	for (int ii = 0; ii < s.size(); ++ii)
//		cout << s;
//	cout << endl;
//	//fin >> piece.m_badge_name;
//	cout << "entering getBadgePiece" << endl;
//
//    while( (input != L"END") && !fin.eof() )
//    {
//        if( input == L"ID" )
...
//        fin >> input;
//    }
//	cout << "exiting getBadgePiece" << endl;
//	return piece;
//}
//

...
int main()
{
    ...
    cout << "Finished writing content files." << endl;
    return 0;
}
...
void writeProfilePageFile(flexifstream& fin)
{
    ...
    cout << "Making Profile Page " << name << "..." << endl;
...
void writeActivityFile(flexifstream& fin)
{
    ...
    cout << "Making Activity " << name << "..." << endl;
...
>>>>>>> a8e2d605afcb0b08ed7fc5f5f5375555b60b13a4
